...
class Gio extends Transform implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (hasApp) {
            ...
            android.registerTransform(this, Collections.EMPTY_LIST)

            project.gradle.addBuildListener(new TimeListener())
        }
    }
    ...
    static boolean checkClassFile(String name) {
        //只处理需要的class文件
        return name.endsWith(".class") && !name.startsWith("R\$") && !"R.class".equals(name) && !"BuildConfig.class".equals(name)&&name.toLowerCase().contains("activity")
